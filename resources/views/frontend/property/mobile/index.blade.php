...
@section('content')
    ...
    <div class="buy_rent_main_div">
        <a class="for-sale activeBtn" href="">
            <button>Buy</button>
        </a>
        <a class="for-rent " href="">
            <button>Rent</button>
        </a>
        <a class="for-booking " href="">
                ...
                <ul>
                    <li>
                        <a href="" class="text-decoration-none">
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="#007bff" height="25" viewBox="-35 0 512 512"
                                    width="25">
                                    <path
                        ...
                        <a href="" class="text-decoration-none">
                            <div>
                                <svg fill="#007bff" xmlns="http://www.w3.org/2000/svg" id="Capa_1"
                                    enable-background="new 0 0 609.619 609.619" height="25" viewBox="0 0 609.619 609.619"
                                    width="25">
                                    <g>
                                        <g id="Page-1_14_">
                                            <g id="_x30_15---Plot-Clipboard">
                                                ...
                                                <g clip-rule="evenodd" fill-rule="evenodd">
                                                    ...
                                                    <path id="Rectangle_23_" d="m141.519 348.354h76.202v43.544h-76.202z" />
                                                    <path id="Rectangle_22_" d="m348.354 217.721h76.202v43.544h-76.202z" />
                                                    <path id="Rectangle_21_" d="m141.519 283.037h76.202v43.544h-76.202z" />
                                                    <path id="Path_108_"
                                                    ...
                                                    <path id="Rectangle_20_" d="m141.519 217.721h76.202v43.544h-76.202z" />
                                                </g>
                                            </g>
                                        </g>
                                    </g>
                    ...
                    <li>
                        <a href="" class="text-decoration-none">
                            <div>
                                <svg fill="#007bff" xmlns="http://www.w3.org/2000/svg" height="25" viewBox="0 -1 456 456"
                                    width="25">
                                    <path
