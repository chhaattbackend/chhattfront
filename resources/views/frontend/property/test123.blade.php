...
<body>
    <div id="root">
        <header id="sctop">
            <div class="property_main" id="head1">
                <div class="s_div navbarContainer">
                    <div class="innerContainer">
                        <div class="logo" id="lgo">
                            <!-- <CgMenuLeftAlt id="mnu" class=menu_icn />  -->
                            <img src="./assets/logow.png" alt="home" />
                        </div>
                        <div class="tabss">
                            <ul>
                                <li style="color: #fff" class="lif">
                                    <span>HOME</span>
                                </li>
                                <li style="color: #fff" class="lis">
                                    <span>Property</span>
                                </li>
                                ...
                                <li style="color: #fff" class="lit">
                                    <span>Wanted</span>
                                </li>
                            </ul>
                        </div>
                        <!-- <div class={cn(Style.signin)}>
              <div class=signin_icn}>
                <BsPersonFill />
              </div>
            </div>  -->
                    </div>
            ...
            <!-- <ProgressiveImage delay={400} src={mainBanner} placeholder={Ig1}>
          {(src, loading) => ( -->
            <div class="mn_div">
                <div class="backg">
        ...
        <div class="mapCardContainer">
            <div class="container-fluid">
                ...
                <div class="row mt-3">
                    <div class="col-sm-4 mx-auto col-lg-3 mb-4">
                        <!-- property card start -->
                        <div class="propertyCard p-2">
        ...
        <footer class="main_foter">
            <div class="sub_div">
                ...
                <b>Search, Compare & Get</b>
                        ...
                        <div class="playIcons">
                            <a href="https://www.instagram.com/chhattcom/?igshid=1aynfz0mquewo" class="icon instagram">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                    class="bi bi-instagram" viewBox="0 0 16 15">
                                    <path
                            ...
                            <a href="https://www.facebook.com/ChhattPK/" class="icon facebook">
                            ...
                            <a href="https://www.youtube.com/channel/UCrQuXvCQMRvNSpaU3znG9cA/featured"
                                class="icon youtube">
        ...
        >>>>>>> 1642b6970f703644b5b13975098ec424878d3722
    </div>
