<div>
                ...
                <div class="product_detail_card_div d-flex">
                    ...
                    <div class="th_div">
                        ...
                        <div class="px-2" style="padding-top: 4rem">
                            <a href="{{ route('construction.singlestore', ['store' => $item->store->slug]) }}">

                                <button class="w-100 py-2 rounded bg-transparent border border-1 border-dark">
                                    View
                                    Store</button>
                            </a>
                        </div>
    ...
    <div class="d-flex justify-content-center">
        {{ $anycategory->storeproductwithpagination()->links('livewire::simple-tailwind') }}
    </div>
</div>
